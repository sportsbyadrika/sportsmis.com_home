      ...
      <div class="row align-items-center g-4 g-lg-5">
        <div class="col-lg-6">
          ...
          <div class="d-flex flex-wrap gap-2">
            <a href="https://app.sportsmis.com/login" class="btn btn-accent btn-lg px-4">Login</a>
            <a href="#features" class="btn btn-outline-ghost btn-lg px-4">Explore Modules</a>
          </div>

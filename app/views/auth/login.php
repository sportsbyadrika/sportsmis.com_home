...
$googleBtnAthlete = '<a href="/auth/google?tab=athlete" class="btn btn-outline-danger w-100 py-2 fw-medium mb-3">
...
$googleBtnInstitution = '<a href="/auth/google?tab=institution" class="btn btn-outline-danger w-100 py-2 fw-medium mb-3">
  <svg xmlns="http://www.w3.org/2000/svg" width="18" height="18" viewBox="0 0 48 48" class="me-2" style="vertical-align:-.2em">
    <path fill="#EA4335" d="M24 9.5c3.54 0 6.71 1.22 9.21 3.6l6.85-6.85C35.9 2.38 30.47 0 24 0 14.62 0 6.51 5.38 2.56 13.22l7.98 6.19C12.43 13.72 17.74 9.5 24 9.5z"/>
    <path fill="#4285F4" d="M46.98 24.55c0-1.57-.15-3.09-.38-4.55H24v9.02h12.94c-.58 2.96-2.26 5.48-4.78 7.18l7.73 6c4.51-4.18 7.09-10.36 7.09-17.65z"/>
    <path fill="#FBBC05" d="M10.53 28.59c-.48-1.45-.76-2.99-.76-4.59s.27-3.14.76-4.59l-7.98-6.19C.92 16.46 0 20.12 0 24c0 3.88.92 7.54 2.56 10.78l7.97-6.19z"/>
  ...
  <div class="p-2" style="background:#f8fafc;border-bottom:1px solid #e2e8f0">
    <ul class="nav nav-pills nav-fill" role="tablist">
      <li class="nav-item" role="presentation">
        <button class="nav-link <?= $activeTab !== 'institution' ? 'active' : '' ?> fw-medium py-2 rounded-2"
                id="athlete-tab" data-bs-toggle="pill" data-bs-target="#paneAthlete"
      ...
      <li class="nav-item" role="presentation">
        <button class="nav-link <?= $activeTab === 'institution' ? 'active' : '' ?> fw-medium py-2 rounded-2"
                id="institution-tab" data-bs-toggle="pill" data-bs-target="#paneInstitution"
                type="button" role="tab">
          ...
          <div class="mb-3">
            ...
            <div class="input-group">
              ...
              <input type="email" name="email"
                     value="<?= $activeTab !== 'institution' ? e(old('email')) : '' ?>"

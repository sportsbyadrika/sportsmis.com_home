  ...
  <div class="container-fluid px-4">
    ...
    <div class="collapse navbar-collapse" id="unitNav">
      <ul class="navbar-nav me-auto mb-2 mb-lg-0">
        ...
        <li class="nav-item">
          <a class="nav-link <?= activeNav('/unit/team-entry') ?>" href="/unit/team-entry">
            <i class="bi bi-people me-1"></i>Team Entry <span class="badge bg-warning-subtle text-warning ms-1">Soon</span>
          </a>
        </li>
        <li class="nav-item">
          <a class="nav-link <?= activeNav('/unit/lane-allocation') ?>" href="/unit/lane-allocation">
            <i class="bi bi-bullseye me-1"></i>Lane Allocation <span class="badge bg-warning-subtle text-warning ms-1">Soon</span>
          </a>
        </li>
      </ul>

<?php $pageTitle = ($site['title'] ?? 'Results'); ?>
<div class="container">
  <div class="d-flex align-items-center gap-2 mb-3 flex-wrap">
    ...
    <a href="/search" class="btn btn-sm btn-warning ms-auto"><i class="bi bi-search me-1"></i>Search by Athlete</a>
  </div>
    ...
    <div class="row g-3">
      <?php foreach ($events as $ev): ?>
        <div class="col-6 col-md-4 col-lg-3">
          <a href="/event/<?= (int)$ev['id'] ?>" class="pr-card ev-card p-3 h-100 text-center">

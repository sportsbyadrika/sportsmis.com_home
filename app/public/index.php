...
$router->get('/institution/events/{id}/reports/unit-emails/print',                  'EventReportController@unitEmailListPrint');
...
$router->post('/institution/registrations/{id}/custom-fields',   'InstitutionController@updateRegistrationCustomFields');
...
$router->post('/institution/team-registrations/{id}/revoke',   'InstitutionController@teamRegistrationRevoke');
...
$router->get('/unit/medal-tally',           'UnitController@medalTally');
...
$router->get('/event-staff/order-of-events',           'OrderOfEventsController@index');
...
$router->post('/event-staff/result-reports/result-status',     'EventStaffController@resultStatusToggle');
...
$router->get('/event-staff/result-reports/track-medal/pivot-print','EventStaffController@trackPivotPrint');
$router->post('/event-staff/result-reports/track-medal/age-config','EventStaffController@trackMedalAgeConfigSave');
...
$router->post('/event-staff/result-reports/certificate/mark-printed',   'EventStaffController@trackCertMarkPrinted');
$router->post('/event-staff/result-reports/certificate/delete-all',     'EventStaffController@trackCertDeleteAll');
...
$router->post('/lane-allocation/track/heat-results-clear', 'LaneAllocationController@heatResultsClear');
